# Generated by Powerlevel10k configuration wizard on 2021-07-18 at 11:55 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_HOME_SUBFOLDER_FOREGROUND="010"
  typeset -g POWERLEVEL9K_DIR_PATH_SEPARATOR="%F{008}/%F{cyan}"
  typeset -g POWERLEVEL9K_HOME_SUB_ICON='%F{blue}\uF07C '
  ...
  functions -M my_git_formatter 2>/dev/null  # Formatter for Git status.
  #
  ...
  # is empty.
  typeset -g CONDA_AUTO_ACTIVATE_BASE=false
